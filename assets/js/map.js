...
function drawVisualization() {
  ...
  data.addRows([    
    ...
    ['Switzerland',1,'Zurich means "too rich" in German. Or at least it looks like it.']
    ['Croatia',1,'Shamelessly walked the Walk of Shame making bell sounds while chanting "Shame"']
  ]);
